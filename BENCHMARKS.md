...
- XR56 removes the dead accepted-prefix re-forward from the default-off
  ...
  selected `chat_short_1k_001:N=3` and `tool_json_1k_001:N=6`; N=6/N=8 remain
