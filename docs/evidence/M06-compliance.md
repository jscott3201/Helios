...
The main behavioral risk is treating fixture exactness as proof of real-model MTP. The code avoids that by fail-closing native assistant execution with `GEMMA4_ERR_UNSUPPORTED_CONFIG` and by documenting the gap in the decision record.
