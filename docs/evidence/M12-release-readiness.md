...
| RAM cache fixture | `cargo run -p gemma4d-kv --example m07_restore_matrix -- --out benchmarks/out/M12/ram-restore-matrix.json` | Passed | `ram-restore-matrix.json` | 4 cases passed with cold and warm RAM TTFT fields. |
